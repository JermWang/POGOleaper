...
function BrandMark({ small = false }: { small?: boolean }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: small ? 16 : 24 }}>
      <Img
        src={staticFile("pogo-poker-chip.png")}
        style={{
          width: small ? 58 : 92,
          height: small ? 58 : 92,
          objectFit: "contain",
          filter: "drop-shadow(0 8px 26px rgba(34,197,94,0.5))",
        }}
      />
      <div
        style={{
      ...
      >
        Pogo<span style={{ color: theme.colors.pogoSoft }}>.</span>
      </div>
    </div>
  );
}
  ...
  return (
    <GlassPanel
      style={{
        padding: 22,
        minHeight: 130,
        borderColor: selected ? "rgba(34,197,94,0.62)" : "rgba(255,255,255,0.09)",
        boxShadow: selected
          ? "0 30px 80px -28px rgba(0,0,0,0.82), 0 0 36px -12px rgba(34,197,94,0.48)"
        ...
        return (
          <div
            ...
            style={{
              ...
              borderRadius: 16,
              border: i === 0 ? "1px solid rgba(34,197,94,0.65)" : "1px solid rgba(255,255,255,0.1)",
              background: "rgba(12,13,16,0.82)",
              padding: "10px 14px",
              fontFamily: theme.fonts.mono,
              color: i === 0 ? theme.colors.pogoSoft : theme.colors.ivory,
              fontSize: 14,
            }}
          >
            {name}
    ...
    >
      <div
        style={{
          width: `${progress * 100}%`,
          height: "100%",
          background: `linear-gradient(90deg, ${theme.colors.pogoDim}, ${theme.colors.pogoSoft})`,
        }}
      />
    </div>
  );
...
export const PogoPlatformPromo = () => {
    ...
    >
      <div
        style={{
          ...
          inset: 0,
          backgroundImage: [
            "radial-gradient(60rem 60rem at 80% -10%, rgba(34,197,94,0.14), transparent 60%)",
