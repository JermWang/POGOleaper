...
export function CardFan() {
  ...
  return (
    <div
      ref={containerRef}
      className="poker-card-fan relative mx-auto flex h-[260px] w-[34rem] max-w-[92vw] origin-center scale-[0.78] items-center justify-center sm:scale-100"
    >
        ...
        {ROYAL_FLUSH.map((card, i) => (
          <div
            ...
            style={{
              ...
              zIndex: i,
              filter: "drop-shadow(0 24px 24px rgba(6,35,30,0.3))",
            }}
          >
