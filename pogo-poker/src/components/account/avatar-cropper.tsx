...
export function AvatarCropper({
  ...
  return (
    <div className="space-y-3">
      <div
        className="relative mx-auto cursor-grab touch-none select-none overflow-hidden rounded-full border-2 border-pogo/40 bg-charcoal-900 active:cursor-grabbing"
