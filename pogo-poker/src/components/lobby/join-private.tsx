  ...
  return (
    <form onSubmit={submit} className="flex w-full max-w-sm items-center gap-2">
      <input
        ...
        className="h-10 flex-1 rounded-xl border border-white/12 bg-charcoal-900/60 px-3 text-sm text-ivory placeholder:text-ash/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-pogo/50"
