 ...
 * a milled pogo edge (stacked translateZ layers), and a pogo-crest back. Pointer
 * tilt, idle float, and a pogo glow are opt-in and respect prefers-reduced-motion.
 *
...
export function Card3D({
  ...
  // Stacked pogo-green layers form the card's milled edge.
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(closest-side, rgba(34,197,94,0.48), rgba(34,197,94,0.08) 55%, transparent 72%)",
            opacity: glow ? 1 : 0,
            filter: "blur(6px)",
          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: "8%",
                background:
                  "repeating-linear-gradient(45deg, rgba(34,197,94,0.32) 0 1.5px, transparent 1.5px 8px), repeating-linear-gradient(-45deg, rgba(34,197,94,0.32) 0 1.5px, transparent 1.5px 8px), #dad5ca",
            ...
            <div style={{ position: "absolute", inset: 0, display: "grid", placeItems: "center" }}>
              <div
                style={{
                  ...
                  boxShadow: "0 0 0 4px rgba(250,248,241,0.85), 0 0 0 5px rgba(34,197,94,0.3)",
          ...
          {layers.map((z, i) => (
            <div
              ...
              style={{
                ...
                background: "linear-gradient(170deg, #86efac 0%, #22c55e 42%, #15803d 100%)",
              }}
            />
          ))}
