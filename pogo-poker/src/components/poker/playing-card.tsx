      ...
      >
        ...
        <div
          style={{
            ...
            background:
              "repeating-linear-gradient(45deg, rgba(34,197,94,0.32) 0 1.5px, transparent 1.5px 7px), repeating-linear-gradient(-45deg, rgba(34,197,94,0.32) 0 1.5px, transparent 1.5px 7px), #dad5ca",
