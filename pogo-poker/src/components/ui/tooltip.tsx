  ...
  return (
    <Tooltip label={label} side={side} className={className}>
      <button
        type="button"
        aria-label="Help"
        className="grid h-4 w-4 place-items-center rounded-full border border-white/15 text-[9px] font-semibold text-ash/80 transition-colors hover:border-pogo/50 hover:text-ivory"
