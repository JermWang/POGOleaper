...
const TOKEN_TAG =
  env.tokenSymbol && env.tokenSymbol !== "TOKEN" ? env.tokenSymbol : "POGO";
...
export default async function LobbyPage() {
  ...
  return (
    <div className="space-y-10 py-2">
      ...
      <div className="glass glass-pogo relative overflow-hidden p-7">
        <div className="pointer-events-none absolute -right-12 -top-16 h-48 w-48 rounded-full bg-pogo/10 blur-3xl" />
      ...
      <div>
        ...
        <p className="mb-5 inline-block rounded-lg border border-pogo/25 bg-pogo/[0.07] px-3 py-1.5 text-sm text-ivory">
          Public games are wagered only in{" "}
          <span className="font-semibold text-pogo">${TOKEN_TAG}</span>.
        </p>
