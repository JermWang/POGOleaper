...
const faqs = [
  {
    ...
    a: "Balances are custodial and recorded in an internal double-entry ledger. Deposits and withdrawals settle on Robinhood Chain. Funds at a table are locked in the ledger until you cash out.",
  },
  {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-8">
      ...
      <p className="text-sm text-ash">
        ...
        <Link href="/legal/rules" className="text-pogo">
          game rules
        </Link>{" "}
        and{" "}
        <Link href="/legal/responsible-gaming" className="text-pogo">
          responsible gaming
        </Link>{" "}
        resources.
      </p>
