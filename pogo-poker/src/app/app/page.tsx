  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 py-4">
      ...
      <Link href="/app/host" className="block">
        <div className="glass glass-pogo glass-hover relative overflow-hidden p-8">
          <div className="absolute -right-10 -top-10 h-44 w-44 rounded-full bg-pogo/10 blur-3xl" />
          ...
          <span className="mt-5 inline-flex items-center gap-2 text-sm font-medium text-pogo">
            Open the host room
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-ash">
        ...
        <span className="text-pogo/30">◆</span>
  ...
  return (
    <Link href={href} className="block">
      <div className="glass glass-hover flex h-full flex-col p-6">
        ...
        <span className="mt-4 font-mono text-xs text-pogo/80">{meta}</span>
      </div>
    </Link>
  );
}
