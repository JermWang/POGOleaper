 ...
 * treasury — and every user deposits to it directly from their connected wallet
 * on Robinhood Chain. The deposit-monitor watches the treasury and attributes
 * each incoming transfer to the user whose linked wallet sent it (see
 * scanTreasuryDeposits).
 *
 * This intentionally avoids per-user deposit keys: no private keys to custody,
