 ...
 *
 * Tiers are defined in USD ($20 entry + the $100 "Pogo Room"). When the token is
...
// the flagship "The Pogo Room" ($100).
const MICRO = { usd: 20, sbUsd: 0.1, bbUsd: 0.2, minUsd: 10, maxUsd: 20 } as const;
const TIERS: Tier[] = [
  { code: "HOUSE-MICRO", name: "Pogo — $20 #1", ...MICRO },
  { code: "HOUSE-MICRO-2", name: "Pogo — $20 #2", ...MICRO },
  { code: "HOUSE-MICRO-3", name: "Pogo — $20 #3", ...MICRO },
  { code: "HOUSE-MICRO-4", name: "Pogo — $20 #4", ...MICRO },
  { code: "HOUSE-MID", name: "The Pogo Room", usd: 100, sbUsd: 0.5, bbUsd: 1, minUsd: 50, maxUsd: 100 },
];
