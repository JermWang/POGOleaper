# Deploying Pogo Poker (Railway)

Pogo Poker runs as **two services** that share one repo and the Supabase
database:
...
```bash
railway init             # creates a project; name it "Pogo Poker"
```
...
railway service web
railway up
railway domain           # e.g. pogo-production-yyyy.up.railway.app
```
